...
export default function MarketServiceDetail() {
  ...
  /*
   * SEO metadata must be defined here, outside submit(),
   * because Helmet is rendered from the component return.
   */
  ...
  const seoUrl = `https://www.conceptcleaningservices.co.ke/service/${
